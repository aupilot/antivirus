...
# Dmytro's
#docker run -t --rm --gpus '"device=0"' -v $(pwd):/workdir --workdir /workdir 8kir8/molecule:0605.1 /usr/bin/python3 /opt/dock-n-score.py $1 $2 $3 $4 $5
#docker run -t --rm --gpus '"device=1"' -v $(pwd):/workdir --workdir /workdir 8kir8/molecule:0605.1 /usr/bin/python3 /opt/dock-n-score.py $1 $2 $3 $4 $5
