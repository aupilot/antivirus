...
# docker run -it --gpus all --rm -v $(pwd):/workdir --workdir /workdir 8kir8/molecule:0501.1 /usr/bin/python3 /opt/dock-n-score.py /workdir/best_01.pdb /workdir/7e3c_spike_alighned.pdb 0.06 1
