...
python3 /home/kir/Apps/alphafold/docker/run_docker.py --fasta_paths=$1 --num_multimer_predictions_per_model=1 --max_template_date=2022-03-01 --use_precomputed_msas=false --model_preset=multimer --db_preset=reduced_dbs --data_dir=/media/kir/HDDData/Datasets/Alphafold
